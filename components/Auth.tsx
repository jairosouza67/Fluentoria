      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in ml-0 lg:ml-12">
        ...
        <div className="mb-8 text-center">
          <div className="inline-block">
            <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-[#FF6A00] via-[#FFB800] to-[#FF6A00] bg-clip-text text-transparent mb-3 drop-shadow-2xl animate-gradient bg-[length:200%_auto] leading-tight">
              Thiago Serpa<br />Fluentoria de Inglês
            </h1>
